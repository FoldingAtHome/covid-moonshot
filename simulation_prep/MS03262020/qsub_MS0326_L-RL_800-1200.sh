...
~/packages/anaconda3/envs/openff/bin/python simulate.py 800 900 0 &

~/packages/anaconda3/envs/openff/bin/python simulate.py 900 1000 1 &

~/packages/anaconda3/envs/openff/bin/python simulate.py 1000 1100 2 &

~/packages/anaconda3/envs/openff/bin/python simulate.py 1100 1200 3 &
