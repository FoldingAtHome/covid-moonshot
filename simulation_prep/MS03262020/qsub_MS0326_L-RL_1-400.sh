...
~/packages/anaconda3/envs/openff/bin/python simulate.py 1 100 0 &

~/packages/anaconda3/envs/openff/bin/python simulate.py 100 200 1 &

~/packages/anaconda3/envs/openff/bin/python simulate.py 200 300 2 &

~/packages/anaconda3/envs/openff/bin/python simulate.py 300 400 3 &
