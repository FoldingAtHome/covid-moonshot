...
prefix = 'sprint-11A'
run_id = 0
overall_description = 'COVID Moonshot Sprint 11A for optimizing 5-spiro compounds'
    ...
    for assembly_state in assembly_states:
        for rmsd_restraint in rmsd_restraints:
            for xchem_fragment_id in reference_compound_ids.keys():
                ...
                description = f"{overall_description} based on {xchem_fragment_id} using reference compound {reference_compound_id} with Mpro {assembly_state} and {charge_state} Cys145:His41 catalytic dyad"
                ...
                fah_projects = ProjectPair(
                    complex_phase=13460, # complex
                    solvent_phase=13461 # solvent
                )
