            ...
            for xchem_fragment_id in reference_compound_ids.keys():
                ...
                with oechem.oemolistream(microstates_sdf_filename) as ifs:
                    for oemol in ifs.GetOEGraphMols():
                        ...
                        microstate = Microstate(microstate_id=microstate_id, smiles=smiles, free_energy_penalty=free_energy_penalty)
                ...
                from fah_xchem.schema import Transformation, CompoundMicrostate, PointEstimate
