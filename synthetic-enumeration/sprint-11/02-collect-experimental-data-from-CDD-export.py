...
cdd_csv_filename = 'experimental-data/CDD CSV Export - 2021-12-28 21h41m57s.csv'
...
# Exchange columns so SMILES is first
...
with oechem.oemolistream(compounds_smi_filename) as ifs:
    for oemol in ifs.GetOEGraphMols():
        ...
        if compound_id in compounds:
            ...
            experimental_data['pIC50_lower'] = - np.log10(IC50_lower)
            experimental_data['pIC50_upper'] = - np.log10(IC50_upper)
