...
def load_fragment(fragid, title=None):
    ...
    """
    refmol_filename = f'receptors/dimer/Mpro-P0033-ligand.mol2'
...
if __name__ == '__main__':
    ...
    # Assay data
    assay_data_filename = 'activity-data/activity_data-2021-05-09.csv'

    # Molecule sets dock
    # This is just the prefix to pull from f"sorted/{prefix}.csv"
    molecule_sets_to_dock = [
        'sprint-7-2021-05-11-stereofilter',
    ]
