...
# DEBUG: Force order
json_filenames = [
#    'json/sprint-5-dimer-x11498-monomer-neutral.json',
#    'json/sprint-5-dimer-x11498-monomer-charged.json',
    'json/sprint-5-dimer-x11498-dimer-neutral.json',
#    'json/sprint-5-dimer-x11498-dimer-charged.json',
]
