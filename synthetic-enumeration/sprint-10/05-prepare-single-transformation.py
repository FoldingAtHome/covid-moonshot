...
def run_relative_perturbation(compound_series, transformation_index, microstate_sdf_filename, tidy=True, rmsd_restraint=True):
    ...
    options['remove_constraints'] = False
    options['num_equilibration_iterations'] = 5000 # 5 ns
...
# DEBUG: Force order
json_filenames = [
    'json/sprint-10-2021-07-26-x10959-dimer-neutral-restrained.json',
    'json/sprint-10-2021-07-26-x10959-dimer-neutral-unrestrained.json',
]
