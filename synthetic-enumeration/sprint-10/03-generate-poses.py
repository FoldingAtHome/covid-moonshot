...
if __name__ == '__main__':
    ...
    # Assay data
    #assay_data_filename = 'activity-data/activity_data-2021-05-30.csv'
    #assay_data_filename = 'activity-data/activity_data-2021-06-14.csv'
    assay_data_filename = 'activity-data/activity_data-2021-07-26.csv'

    # Molecule sets dock
    # This is just the prefix to pull from f"sorted/{prefix}.csv"
    molecule_sets_to_dock = [
        #'sprint-9-2021-06-14',
        'sprint-10-2021-07-26',
    ]
